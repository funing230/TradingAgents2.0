...
from tradingagents.dataflows.realtime_snapshot_provider import (
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fetch Tushare realtime snapshot for 14:55 live overnight inference")
    parser.add_argument("--trade-date", required=True, help="Decision date, YYYY-MM-DD")
    parser.add_argument("--source", default="tushare", choices=["tushare"], help="Realtime source")
