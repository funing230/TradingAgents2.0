...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            + (" In overnight mode, do not call company-news tools for the synthetic label. Instead, analyze the provided overnight candidate context and global market context directly, and write a sentiment-style report for the overnight basket." if is_overnight else "")
